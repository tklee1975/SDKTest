...
{
	Point pos = Point(0, getTopBarPos());
...
int TDDSuiteLayer::getTopBarPos()
{
	return TDDHelper::getTopMargin() + kToolBarHeight;
}
...
{
	Size screenSize = TDDHelper::getScreenSize();
	Size menuSize = Size(screenSize.width, screenSize.height - getTopBarPos());
